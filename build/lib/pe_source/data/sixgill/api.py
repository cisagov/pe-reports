...
def post_organization(
    ...
    """Add a new organization to SixGill."""
    url = "https://api.cybersixgill.com/multi-tenant/organization"
    auth = token()
    headers = {
        "Content-Type": "application/json",
...
def alerts_delete(
    ...
    """Delete a list of actionable alerts by ID with optional filters."""
    url = "https://api.cybersixgill.com/alerts/actionable-alert"
    auth = token()
    headers = (
        {
...
def alerts_patch(
    ...
    """Update a list of actionable alerts by ID with optional filters."""
    url = "https://api.cybersixgill.com/alerts/actionable-alert"
    auth = token()
    headers = (
        {
...
def alert_delete_id(actionable_alert_id, organization_id="organization_id"):
    """Delete an actionable alert by ID."""
    url = "https://api.cybersixgill.com/alerts/actionable-alert/" + actionable_alert_id
    auth = token()
    headers = (
        {
...
def alert_patch_id(actionable_alert_id, organization_id="organization_id"):
    """Update an actionable alert by ID."""
    url = "https://api.cybersixgill.com/alerts/actionable-alert/" + actionable_alert_id
    auth = token()
    headers = (
        {
...
def alert_stats(organization_id="organization_id", threat_level="imminent"):
    """Get actionable alerts statistics per user."""
...
def get_content_id(
    ...
    """Get actionable alert content by alert ID."""
    url = (
