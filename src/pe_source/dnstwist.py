...
# """Select domains and ips from Crossfeed"""
# try:
#     sql = f"""SELECT org."name", dom."ip", dom."fromRootDomain"
#                 FROM organiztion as org
#                 WHERE dom."organizationId" ='{org_id}'"""
#     domain_resp = query_db(CF_conn, sql)
#     df = pd.DataFrame.from_records(domain_resp)
#     print(df)
#
#
# except:
#     print("Failure getting domain data")
#     print(traceback.format_exc())
...
#         blocklist_report_count = EXCLUDED.blocklist_report_count;""".format(
#         table,
#         ",".join(columns),
#     )
