...
def dedupe(orgs):
    ...
    key = "dkx4uJW66PXjihngybpdWuuJjNF7yxrE"
    api = shodan.Shodan(key)
    # , 'USTDA', 'VA', 'DHS_ST', 'DOC_BEA', 'DOC_BIS', 'DOC_CENSUS', 'DOC_NIST', 'DOC_NOAA', 'DOC_NTIA', 'DOC_OS', 'DOC_USPTO', 'NRC', 'EAC', 'ED', 'GSEC', 'GSA', 'HHS', 'HHS_NIH', 'NASA', 'OPM', 'CFPB', 'NSF', 'SSS', 'DOC_OIG', 'DOL_BLS'
    for i, org in orgs.iterrows():
        # if org['cyhy_db_name'] in [ 'DHS_NPPD', 'DHS_CBP', 'DHS_CIS', 'DHS_FEMA',
        # 'DHS_FLETC', 'DHS_ICE', 'DHS_TSA', 'DHS_USSS','DOI_OS-OAS', 'DOC','DOI_OSM',
        # 'DOL','DOE','DOS','DOJ','DOT','HHS_FDA','HUD','SBA','DOI_OS','DOI_IBC','DOI',
        # 'DOI_NPS','DOI_BIA','DOI_BLM', 'DOI_FWS', 'DOI_BSEE-BOEM-ONRR', 'DOI_BOR', 'EOP',
        # 'EPA', 'SSA', 'USAID','USDA']:
        #     continue
...
def main():
    """Get all organization information from shodan."""
    orgs = get_orgs_df()
    orgs = orgs[orgs["report_on"] is True]
    print(orgs)
