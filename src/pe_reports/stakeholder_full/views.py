...
# cisagov Libraries
from adhoc.enumberate_subs_from_root import enumerate_and_save_subs, query_roots
...
def set_org_to_report_on(cyhy_db_id):
    ...
    if len(df) < 1:
        print("No org found for that cyhy id")
        return 0
...
def stakeholder_full():
    ...
    if formExternal.validate_on_submit():
        ...
        if orgs.empty:
            print("No org found for the given cyhy_id")
            ...
            try:
                ...
                for i, org in orgs.iterrows():
                    ...
                    print("root domains have been successfully added to the database")
                    ...
                    print("subdomains have been successfully added to the database")
                ...
                # print("Filled and linked all IPs")
                ...
                print(cust)
                print(custDomainAliases)
                print(custRootDomain)
                print(allValidIP)
