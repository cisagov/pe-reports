...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CpeVender',
            fields=[
                ('cpe_vender_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Cves',
            fields=[
                ('cve_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
                ...
                ('weaknesses', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True, null=True), blank=True, null=True, size=None)),
                ('reference_urls', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True, null=True), blank=True, null=True, size=None)),
                ('cpe_list', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True, null=True), blank=True, null=True, size=None)),
            ],
            options={
                'db_table': 'cves',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('organizations_uid', models.UUIDField(primary_key=True, serialize=False)),
                ('cyhy_db_name', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cve_name', models.CharField(blank=True, max_length=255, null=True)),
                ('cvss_score', models.FloatField(blank=True, null=True)),
                ('owasp_category', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('xpanse_business_unit_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='XpanseAssets',
            fields=[
                ('xpanse_asset_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
                ...
                ('externally_detected_providers', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('created', models.DateTimeField(blank=True, null=True)),
                ('ips', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('active_external_services_types', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ...
                ('certificate_classifications', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ...
                ('externally_inferred_vulnerability_score', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('externally_inferred_cves', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('explainers', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='XpanseCves',
            fields=[
                ('xpanse_cve_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False, unique=True)),
                ('cve_id', models.TextField(blank=True, null=True, unique=True)),
                ('cvss_score_v2', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('cve_severity_v2', models.TextField(blank=True, null=True)),
                ('cvss_score_v3', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_observed', models.DateTimeField(blank=True, null=True)),
                ('last_observed', models.DateTimeField(blank=True, null=True)),
                ('xpanse_inferred_cve', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.xpansecves')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='XpanseServices',
            fields=[
                ('xpanse_service_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
                ...
                ('ip_address', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('domain', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('externally_detected_providers', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ...
                ('active_classifications', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('inactive_classifications', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ...
                ('cves', models.ManyToManyField(through='home.XpanseCveService', to='home.xpansecves')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='xpanse_service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.xpanseservices'),
        ),
        migrations.CreateModel(
            name='XpanseAlerts',
            fields=[
                ('xpanse_alert_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
                ...
                ('action_country', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('action_remote_port', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(blank=True), blank=True, null=True, size=None)),
                ...
                ('event_timestamp', django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(blank=True), blank=True, null=True, size=None)),
                ...
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('last_observed', models.DateTimeField(blank=True, null=True)),
                ('country_codes', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('cloud_providers', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('ipv4_addresses', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('domain_names', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('service_ids', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('website_ids', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ('asset_ids', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), blank=True, null=True, size=None)),
                ...
                ('assets', models.ManyToManyField(related_name='alerts', to='home.xpanseassets')),
                ('business_units', models.ManyToManyField(related_name='alerts', to='home.xpansebusinessunits')),
                ('services', models.ManyToManyField(related_name='alerts', to='home.xpanseservices')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='CpeProduct',
            fields=[
                ('cpe_product_uid', models.UUIDField(default=uuid.uuid1, primary_key=True, serialize=False)),
                ('cpe_product_name', models.TextField(blank=True, null=True)),
                ('version_number', models.TextField(blank=True, null=True)),
                ('cpe_vender_uid', models.ForeignKey(db_column='cpe_vender_uid', default=None, on_delete=django.db.models.deletion.CASCADE, to='home.cpevender')),
                ('cves', models.ManyToManyField(related_name='products', to='home.cves')),
            ],
            options={
