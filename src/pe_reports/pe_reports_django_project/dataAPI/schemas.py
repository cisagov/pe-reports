...
class UniversalCrossfeedVuln(BaseModel):
    """UniversalCrossfeedVuln schema class."""
    ...
    service_asset_type: Optional[str] = None

    class Config:
        """UniversalCrossfeedVuln schema config class."""
