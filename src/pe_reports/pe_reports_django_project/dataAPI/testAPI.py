...
headers = {"Content-Type": "application/json", "access_token": f'{config("API_KEY")}'}
...
def checkAcessExpiration():
    """Define checkAcessExpiration function."""
