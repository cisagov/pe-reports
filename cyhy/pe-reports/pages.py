...
class Pages:
    ...
    def cover(prs):
        ...
        run = frame.add_run()
        df_customer = pd.read_csv("cyhy/pe-reports/data/csv/dhs_customer.csv")
        dates = (
    ...
    def overview(prs):
        ...
        run = frame.add_run()
        df_creds = pd.read_csv("cyhy/pe-reports/data/csv/dhs_creds.csv")
        ...
        run = frame.add_run()
        df_domains = pd.read_csv("cyhy/pe-reports/data/csv/dhs_domains.csv")
        ...
        run = frame.add_run()
        df_malware = pd.read_csv("cyhy/pe-reports/data/csv/dhs_malware.csv")
        ...
        run = frame.add_run()
        df_vulns = pd.read_csv("cyhy/pe-reports/data/csv/dhs_vulns.csv")
        ...
        run = frame.add_run()
        df_web = pd.read_csv("cyhy/pe-reports/data/csv/dhs_web.csv")
        ...
        tld_df = pd.read_csv("cyhy/pe-reports/data/csv/dhs_tld_df.csv").fillna(0)
        ...
        chart = CategoryChartData()
        ce_df = pd.read_csv("cyhy/pe-reports/data/csv/dhs_ce_df.csv").fillna(0)
        ...
        chart = CategoryChartData()
        web_df = pd.read_csv("cyhy/pe-reports/data/csv/dhs_web_df.csv").fillna(0)
        ...
        ma_df = pd.read_csv("cyhy/pe-reports/data/csv/dhs_ma_df.csv").fillna(0)
        ...
        chart = CategoryChartData()
        iv_df = pd.read_csv("cyhy/pe-reports/data/csv/dhs_iv_df.csv").fillna(0)
